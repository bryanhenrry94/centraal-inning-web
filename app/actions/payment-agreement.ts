...
export const getPaymentAgreementsByCollection = async (
  ...
  return agreements.map((agreement) => ({
    ...
    complianceStatus: String(agreement.complianceStatus),
...
export const createPaymentAgreement = async (data: PaymentAgreementCreate) => {
  const newAgreement = await prisma.paymentAgreement.create({
    data: {
      ...
      status: $Enums.AgreementStatus.ACTIVE,
      complianceStatus: $Enums.ComplianceStatus.ON_TIME,
  ...
  return {
    ...
    complianceStatus: String(newAgreement.complianceStatus),
...
export const updatePaymentAgreement = async (
  ...
  return {
    ...
    complianceStatus: String(updatedAgreement.complianceStatus),
